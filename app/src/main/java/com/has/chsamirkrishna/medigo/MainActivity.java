...
public class MainActivity extends FragmentActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Toast.makeText(MainActivity.this,"Please rate us at playstore",Toast.LENGTH_LONG).show();
    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            ...
            case R.id.B_schools:
                mMap.clear();
                String school = "clinics";
                url = getUrl(cur_lat,cur_lng, school);
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;

                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MainActivity.this, "Showing Nearby Clinics", Toast.LENGTH_SHORT).show();
                break;
            case R.id.B_restaurants:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MainActivity.this, "Showing Nearby Medical shops", Toast.LENGTH_SHORT).show();
                break;
